...
<b style='color:purple'> (<?php echo htmlentities(htmlentities($_SESSION['fullname2'], ENT_QUOTES, "UTF-8")); ?>)</b></h3></center><br>
...
<li class='seeking_css'><a style='color:white;' href="dashboard_requset.php?data_type=Composts">Composts</a></li>
<li class='seeking_css'><a style='color:white;' href="dashboard_requset.php?data_type=Plastic-Bottles-and-Cans-Trash">Plastic Bottles and Cans Trash</a></li>
...
alert('Price Status cannot be Empty');
//return false;
}
else if(price_amount==""){
alert('Price Amount cannot be Empty');
//return false;
}

else if(isNaN(price_amount)){
  alert("Price/Amount must be a number");
}
...
form_data.append('price_status', price_status);
...
var recx = "<div class='form-group'><b>Enter Price/Amount (USD)</b>" +
"<input type='text' name='price_amount' id='price_amount' class='form-control col-sm-12'  style=''>" +
 "</div>";
$('.myinput').html(recx);
...
var recx = "<div class='form-group'>" +
"<input type='hidden' name='price_amount' id='price_amount' class='form-control col-sm-12' value='0' style=''>" +
 "</div>";
$('.myinput').html(recx);
...
<option value="Composts">Composts</option>
<option value="Plastic-Bottles-and-Cans-Trash">Plastic Bottle & Can Trash</option>
...
<div class="col-sm-12 form-group">
<label>Select  Photo of the Content: </label>
...
<div class="col-sm-12 form-group">
<label>Select  Price Status </label>
<select class="form-control select_btn price_status" name="price_status" id="price_status" required style="">
