...
$uid = strip_tags($_SESSION['uid2']);
$userid = $uid;
$fullname = strip_tags($_SESSION['fullname2']);
$username =  strip_tags($_SESSION['username2']);
$photo = strip_tags($_SESSION['photo2']);
$email = strip_tags($_SESSION['email2']);
...
$price_status = strip_tags($_POST['price_status']);
